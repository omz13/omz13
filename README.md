...
I make things[^my-iw-things] for the #SmallWeb or #PersonalWeb or whatever its called these days; I'm taking a hiatus[^indieweb-hiatus] from being directly involved with the [_IndieWebCamp_](https://indieweb.org/) community because reasons[^indieweb-sucks][^indieweb-gah].
...
[^indieweb-sucks]: dogma, groupthink, confirmation bias, hypocrisy, lack of resilience, diminishing relevance, and most especially the pushback in #indieweb-dev.
